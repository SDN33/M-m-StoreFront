...
const ContactPage = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 py-28 pb-10 bg-gradient-to-b from-white to-orange-50" style={{ paddingTop: '170px' }}> {/* Augmenté padding-top et réduit la largeur max */}
