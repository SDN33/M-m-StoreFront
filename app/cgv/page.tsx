...
const CGV: React.FC = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-primary px-4 py-8">
      <br /><br /><br /><br />
      <div className="max-w-2xl w-fit bg-gray-100 p-6 sm:p-8 shadow-lg rounded-lg text-center">
        <h1 className="text-2xl sm:text-3xl font-bold text-center mb-4 sm:mb-6 text-primary">Conditions Générales de Vente (CGV)</h1>
