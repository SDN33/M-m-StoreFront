...
const CGV: React.FC = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-orange-600 px-4 py-8 mt-20">
      <br /><br /><br /><br />
      <div className="max-w-2xl w-fit bg-white p-6 sm:p-8 shadow-lg rounded-lg text-center">
