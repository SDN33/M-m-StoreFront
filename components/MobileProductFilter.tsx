  ...
  return (
    <>
      <button
        ...
        className="fixed left-0 top-1/2 -translate-y-1/2 bg-orange-600 text-white p-3 rounded-r-md shadow-lg md:hidden sm:z-50"
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 mpf">
