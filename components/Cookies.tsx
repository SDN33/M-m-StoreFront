...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 md:max-w-lg mx-auto">
      <div className="bg-[#ff7961] rounded-lg shadow-lg border border-gray-100 p-4 text-sm bg-opacity-90">
        <div className="space-y-3">
          <p className="text-white text-center">
            🍪 Nous utilisons des cookies pour améliorer votre expérience client.<br />Veuillez accepter nos cookies pour continuer.
          </p>
          ...
          <div className="flex justify-center gap-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-white text-[#ff7961] rounded-md hover:bg-gray-100 transition-colors text-sm font-medium"
            >
              Personnaliser
            </button>
            <button
