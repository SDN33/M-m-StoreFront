...
const Livraison: React.FC = () => {
  return (
    <>
      <div className="bg-gradient-to-r from-primary via-orange-900 to-red-900 text-white p-6 shadow-lg flex flex-col md:flex-row items-center justify-center md:space-x-4 rounded-xl">
