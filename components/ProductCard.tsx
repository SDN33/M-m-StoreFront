  ...
  return (
    <div className="w-full max-w-[400px] min-w-[300px] bg-white rounded-lg overflow-hidden shadow-md mb-8">
      ...
      <div className="p-3">
        ...
        <a href={`/product/${product.id}`} onClick={handleRedirect} className="text-xs text-gray-900 h-8 overflow-hidden text-center mt-4 font-medium mb-4 flex justify-center cursor-pointer">
