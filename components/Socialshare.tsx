  ...
  return (
    <div className="flex flex-col items-start space-y-2 relative">
      ...
      <div className="flex space-x-4">
        <a href={shareLinks.facebook} target="_blank" rel="noopener noreferrer" className="text-accent hover:text-primary">
          <Facebook size={24} />
        </a>
        <a href={shareLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="text-accent hover:text-primary">
        ...
        <a href={shareLinks.linkedin} target="_blank" rel="noopener noreferrer" className="text-accent hover:text-primary">
          <Linkedin size={24} />
        </a>
        <a href={shareLinks.email} className="text-accent hover:text-primary">
          <Mail size={24} />
        </a>
        <button onClick={copyToClipboard} className="text-accent hover:text-primary">
          <Link size={24} />
        </button>
      </div>
      {showNotification && (
