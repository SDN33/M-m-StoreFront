  ...
  return (
    <div className="flex flex-col items-start space-y-2 relative">
      ...
      <div className="flex space-x-4">
        <a href={shareLinks.facebook } aria-label='facebook' aria-hidden='true' target="_blank" rel="noopener noreferrer" className="text-accent hover:text-primary">
          <Facebook size={24} />
        </a>
        ...
        <a href={shareLinks.linkedin} aria-label='linkedin' aria-hidden='true'  target="_blank" rel="noopener noreferrer" className="text-accent hover:text-primary">
          <Linkedin size={24} />
        </a>
