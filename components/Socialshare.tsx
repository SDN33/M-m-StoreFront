  ...
  return (
    <div className="flex flex-col items-start space-y-4 relative">
      ...
      <div className="flex space-x-4">
        ...
        <a href={shareLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="text-accent hover:text-orange-800">
        ...
        <a href={shareLinks.linkedin} target="_blank" rel="noopener noreferrer" className="text-accent hover:text-orange-800">
          <Linkedin size={24} />
        </a>
        <a href={shareLinks.email} className="text-accent hover:text-orange-800">
          <Mail size={24} />
        </a>
        <button onClick={copyToClipboard} className="text-accent hover:text-orange-800">
          <Link size={24} />
        </button>
      </div>
      {showNotification && (
