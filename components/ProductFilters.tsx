...
const ProductFilter: React.FC<ProductFilterProps> = ({
  ...
  return (
    <div ref={filterContainerRef} className=" custom-scrollbar -px-10 bg-transparent backdrop-blur-sm overflow-y-auto h-screen min-w-full transition-all duration-300 ease-in-out mt-48 md:mt-40 lg:mt-48 mr-14">
      ...
      <button onClick={isHGPrixMatch} className="mt-20 mb-2 p-2 text-center rounded-lg border-black mx-auto bg-gradient-to-r from-gray-800 via-gray-800 to-gray-900 text-white hover:from-red-700 hover:via-red-800 hover:to-red-500 transition-all duration-300 text-sm w-full">
      ...
      <button onClick={isPetitPrixMatch} className="p-2 text-center rounded-lg border-black mx-auto bg-gradient-to-r from-primary via-orange-800 to-red-900 text-white hover:from-orange-700 hover:via-primary hover:to-orange-500 transition-all duration-300 text-sm w-full">
        <div className='flex items-center justify-center text-center mx-auto space-x-4'>
