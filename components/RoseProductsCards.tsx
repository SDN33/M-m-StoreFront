...
const RoseProductsCards: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filtrer pour ne garder que les produits avec une catégorie "rose"
        const filteredProducts = response.data.filter((product: Product) =>
          product.categories.some(category => category.name.toLowerCase() === 'rose')
        );
...
export default RoseProductsCards;
