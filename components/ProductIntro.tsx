...
const ProductsIntro: React.FC = () => {
  ...
  return (
    ...
    <div
      ref={introRef}
      className="relative overflow-hidden bg-gray-100 px-4 sm:px-6 md:px-8 lg:px-18 sm:py-24 md:py-32 shadow-lg text-center slide-in mt-2 md:mt-16 lg:mt-3 mb-16 lg:mb-0"
    >
